...
public class ThemHangActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Thêm hãng điện thoại");
    ...
    private void themHangDienThoai() {
        ...
        if (dataIsValid(hangDienThoai)) {
            long idHangDienThoai = mTuongTacDatabase.themHDT(hangDienThoai);
    ...
    private HangDienThoai getDataForm() {
        ...
        return new HangDienThoai(ma, ten, mota);
    }
